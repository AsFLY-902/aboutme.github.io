$(window).load(function() {
    ...
    (function() {
		...
		MESSAGES.push({
            delay: 500,
            text: ' —  Presently Studying at JIET;'
        });

        MESSAGES.push({
            delay: 1000,
            text: ' —  Android Application Developer/ Web Developer & XD ;'
        });
        MESSAGES.push({
            delay: 1800,
            text: ' —  Knowledge of PHP, JAVA, C, C++, JS, Basic Ethical hacking).'
        });
        MESSAGES.push({
            delay: 3200,
            text: ' —  Loves Tech-Gadgets more than Humans '
        });
        MESSAGES.push({
            delay: 3200,
            text: ' —   Memes Lover'
